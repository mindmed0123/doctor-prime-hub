  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        ...
        <Card className="p-4 border-l-4 border-l-accent bg-accent/30">
          <p className="font-medium text-foreground">
      ...
      <div className="space-y-4">
        ...
        <div className="grid sm:grid-cols-2 gap-3 pt-2">
          <a
            ...
            className="flex items-center gap-3 p-4 rounded-lg border border-border bg-card hover:border-primary hover:shadow-sm transition-all"
          >
    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 pt-20">
        <section className="relative overflow-hidden border-b border-border">
          ...
          <div className="relative container mx-auto px-4 py-16 md:py-24 max-w-5xl">
            <div className="flex flex-col items-start gap-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
              ...
              <h1 className="font-mono text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-foreground text-balance">
                Política de{" "}
        ...
        <section className="container mx-auto px-4 py-10 max-w-5xl">
          <Card className="p-6 md:p-8 border-l-4 border-l-primary shadow-sm">
        ...
        <section className="container mx-auto px-4 pb-20 max-w-7xl">
          <div className="grid lg:grid-cols-[260px_1fr] gap-10">
                        ...
                        return (
                          <li key={s.id}>
                            <button
                              ...
                              className={cn(
                                "w-full text-left flex items-start gap-3 px-3 py-2.5 rounded-lg text-sm transition-all group relative",
                                active
            ...
            <div ref={contentRef} className="min-w-0">
              {isMobile ? (
                <Accordion type="single" collapsible className="space-y-3">
                  {sections.map((s) => (
                    <AccordionItem
                      ...
                      value={s.id}
                      id={s.id}
                      className="border border-border rounded-xl bg-card px-4 shadow-sm overflow-hidden"
                    >
                ...
                <div className="space-y-6">
                  {sections.map((s, idx) => (
                    ...
                    >
                      <Card className="p-7 md:p-9 border-border/70 hover:shadow-md transition-all break-words">
                        <header className="flex items-start gap-4 mb-5 pb-5 border-b border-border/60">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <h2 className="font-mono text-2xl md:text-[28px] font-bold text-foreground tracking-tight leading-tight">
                              {s.title}
                            </h2>
                          </div>
                        </header>
              ...
              <Card className="mt-10 p-8 md:p-10 border-primary/20 bg-primary/5 text-center">
