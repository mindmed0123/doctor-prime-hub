import { Clock, DollarSign, TrendingUp, Loader2 } from "lucide-react";
          ...
          <div className="rounded-xl md:rounded-2xl border border-primary/20 bg-primary/5 p-6 md:p-10 text-center">
            ...
            <div className="mt-6 md:mt-8">
              <button
                ...
                disabled={loading}
                className="inline-flex items-center gap-2 text-sm md:text-[15px] font-semibold text-primary-foreground bg-primary hover:bg-primary/90 rounded-full px-6 md:px-8 py-3 md:py-3.5 transition-colors shadow-lg shadow-primary/25 disabled:opacity-70"
              >
